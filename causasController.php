...
if(isset($_SESSION['nombre'])){
        ...
        switch ($_SERVER['REQUEST_METHOD']){
            case 'GET':
                if($_GET['grafica'] && $_GET['equipo'] && $_GET['anio'] && $_GET['mes']){
                    $grafica = $_GET['grafica'];
                    $equipo = $_GET['equipo'];
                    $anio = $_GET['anio'];
                    $mes = $_GET['mes'];
                    $resultado = consultarCausas($grafica,$equipo,$anio,$mes);
                }else{
            ...
            case 'POST':
                ...
                $mes = $arreglo['mes'];
                $dia = $arreglo['dia'];
                $resultado = guardarCausa($tabla,$equipo,$responsable,$causa,$anio,$mes,$dia);
                break;
            case 'PUT':
                $id =$arreglo['id'];
                $responsable =$arreglo['responsable'];
