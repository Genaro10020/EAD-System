...
include("conexionGhoner.php");
    ...
    function consultarCompetenciaXEvaluador($id_evaluador){
        ...
        $query = "SELECT calificacion.id AS id_calificacion,calificacion.comentario, calificacion.id_ead_foro, ead_foro.proyecto, foros.planta, foros.area, equipos_ead.id AS id_equipo, equipos_ead.nombre_ead, calificacion.calificacion, ead_foro.orden 
        FROM equipos_ead
        ...
        WHERE calificacion.id_evaluador='$id_evaluador' AND foros.estatus!='Cerrado' 
        GROUP BY calificacion.id_ead_foro
        ORDER BY ead_foro.orden ASC";
